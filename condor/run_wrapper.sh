#!/bin/bash
# ==============================================================================
# run_wrapper.sh - HTCondor wrapper for JJPMCAnalyzer jobs
# ==============================================================================
# This wrapper sets up the CMSSW environment and runs the analysis script.
#
# Usage (from HTCondor):
#   arguments = "run_analysis.sh -m DPS_1 -j 8"
# ==============================================================================
...
echo "=============================================="
echo "HTCondor Job Wrapper - JJPMCAnalyzer"
echo "=============================================="
echo "Date: $(date)"
echo "Host: $(hostname)"
...
# ==============================================================================
# Setup VOMS Proxy (for xrootd access to T2_CN_Beijing)
# ==============================================================================
...
PROXY_LOCATIONS=(
    "$X509_USER_PROXY"
    "/afs/cern.ch/user/x/xcheng/x509up_u180107"
    "/tmp/x509up_u$(id -u)"
)
