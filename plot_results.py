...
def plot_kinematics(fin, output_dir):
    ...
    if h_jpsi1_pt and h_jpsi2_pt and h_phi_pt:
        ...
        h_jpsi1_pt.SetTitle("Transverse Momentum Distributions (TPS)")
    ...
    if h_jpsi1_eta and h_jpsi2_eta and h_phi_eta:
        ...
        h_jpsi1_eta.SetTitle("Pseudorapidity Distributions (TPS)")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Plot gen correlation results for TPS')
