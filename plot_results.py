#!/usr/bin/env python3
"""
Plot the results from gen_correlation_histograms_sps.root
...
def plot_kinematics(fin, output_dir):
    ...
    if h_jpsi1_pt and h_jpsi2_pt and h_phi_pt:
        ...
        h_jpsi1_pt.SetTitle("Transverse Momentum Distributions (SPS)")
    ...
    if h_jpsi1_eta and h_jpsi2_eta and h_phi_eta:
        ...
        h_jpsi1_eta.SetTitle("Pseudorapidity Distributions (SPS)")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Plot gen correlation results (SPS)')
